...
async function checkDatabase() {
  ...
  try {
    ...
    // Intentar consultar tablas específicas que podrían existir en Supabase
    console.log('Intentando consultar tablas específicas...');
    ...
    const tablas = [
      ...
      'waitlist', 'demo_requests', 'user_roles_control',
