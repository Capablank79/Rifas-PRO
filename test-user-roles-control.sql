-- Script para probar la creación de la tabla user_roles_control

-- Eliminar la tabla si existe para probar desde cero
DROP TABLE IF EXISTS user_roles_control CASCADE;
